...
import AccountCardHolder from './AccountCardHolder';
import ImageList from '@material-ui/core/ImageList';
import ImageListItem from '@material-ui/core/ImageListItem';
function ListOfAllAccounts(props) {
                   ...
                   <div className={classes.root}>
                        <ImageList rowHeight={470} className={classes.imageList} cols={3}>
                             ...
                             <ImageListItem key={item.img} cols={item.cols || 1}>
                                <div className={classes.projectHolderContainer}>
                                   <AccountCardHolder ptojectTitle={item.ptojectTitle} projectKey={item.projectKey} cols={item.cols} img={item.img} handelOptionSelection={props.handelOptionSelection}/>
                                </div>
                             </ImageListItem>
                        ))}
                        </ImageList>
