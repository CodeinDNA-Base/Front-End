...
//Material-UI core
import { Box, Button, Divider, Grid, makeStyles, Slider, Typography, useMediaQuery } from "@material-ui/core";
  ...
  return (
    <Box className={classes.root} p={0.5} boxShadow={1} mt={2}>
      <Grid container>
        ...
        <Grid item lg={2} xs={3}>
          <Box flex={"auto"} className={classes.boxStyle} ml={isItMobile?4:0}>
        ...
        <Grid item lg={3}>
          <Box flex={"auto"} className={classes.boxStyle}>
            <Button variant="outlined" className={classes.ongoingOrderButton} fullWidth>
              Contact Seller
            </Button>
            </Box>
            <Box flex={"auto"} className={classes.boxStyle} mt={1}>
            <Button variant="contained" color="primary" className={classes.ongoingOrderButton} fullWidth>
              View Order
            </Button>
          </Box>
        </Grid>
      ...
      <Grid container>
        ...
        <Grid item lg={2} xs={2} className={classes.gridStyle}>
          <Box flex={"auto"} className={classes.boxStyle}>
            ...
            <p className={classes.statValue}>
              <ClockIcon className={classes.statValue}></ClockIcon> {new Date().toDateString()}
            </p>
          </Box>
        </Grid>
